 ...
 * @param name {string} новое имя файла
 * @param node {string} путь к каталогу в котором находится файл
 * @param curname {string} текущее имя файла
 */
 ...
 * @param name {string} имя нового файла
 ...
 * @param node {string} путь к каталогу в котором находится файл
 * @param data {string} конечное содержимое файла
 */
